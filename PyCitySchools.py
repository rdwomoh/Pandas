...
overal_passing_rate = passing_math_reading_count / float(student_count) * 100
print(overal_passing_rate)
...
district_summary = pd.DataFrame(
    {
        ...
        "% Overall Passing": [overal_passing_rate]
    }
)
...
school_types = pd.Series(school_types)
school_types
...
per_school_math = school_data_complete["math_score"].median()
per_school_reading = school_data_complete["reading_score"].median()
...
schools_bottom = per_school_summary.sort_values(["% Overall Passing"], ascending=True)
schools_bottom.head(10)
...
schools_bottomss = per_school_summary.sort_values(["% Overall Passing"], ascending=False)
schools_bottomss.head(10)
